...
namespace NYCTaxiData.Application.Features.Drivers.Queries.GetDriverEarnings
{
    ...
    : IRequestHandler<GetDriverEarningsQuery, Result<DriverEarningsDto>>
    {
        ...
        // 1️⃣ كلاسات داخلية صريحة لمنع الـ dynamic والـ RuntimeBinderException نهائياً
            ...
            CancellationToken cancellationToken)
        {
            ...
            // 🛠️ التعديل الجوهري: القراءة عبر كلاس وسيط ثم الـ Cast لـ double لمنع الـ Exception

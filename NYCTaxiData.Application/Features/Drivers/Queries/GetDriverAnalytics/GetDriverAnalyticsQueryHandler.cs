...
namespace NYCTaxiData.Application.Features.Drivers.Queries.GetDriverAnalytics
{
    ...
    : IRequestHandler<GetDriverAnalyticsQuery, Result<DriverAnalyticsDto>>
    {
        ...
        // 1?? ﬂ·«”«  œ«Œ·Ì… ’—ÌÕ… ·„‰⁄ «·‹ dynamic Ê«·‹ RuntimeBinderException  „«„«
        private class DbSummaryResult
        {
            public decimal TotalEarnings { get; set; }
            public long CompletedTrips { get; set; } // «·‹ COUNT(*) ›Ì PostgreSQL » —Ã⁄ bigint/long
            ...
            CancellationToken cancellationToken)
        {
            ...
            // 2. Õ”«» ﬂ„ ÌÊ„ ›«  ⁄·Ï »œ«Ì… «·√”»Ê⁄ (»›—÷ ≈‰ «·√”»Ê⁄ Ì»œ√ «·≈À‰Ì‰ „À·« DayOfWeek.Monday)
            int diff = (7 + (today.DayOfWeek - DayOfWeek.Monday)) % 7;
            var startRange = today.AddDays(-diff); //  «—ÌŒ ÌÊ„ «·≈À‰Ì‰ «·„«÷Ì «·”«⁄… 12 »«··Ì·

            // 3. ‰Â«Ì… «·√”»Ê⁄ «·Õ«·Ì («·√Õœ «·ﬁ«œ„ «·”«⁄… 11:59 „”«¡)
            var endRange = startRange.AddDays(7).AddTicks(-1);

            // Õ”«»«  «·√”»Ê⁄ «·”«»ﬁ (Trends) Â „‘Ì √Ê Ê„« Ìﬂ »—÷Â:
            ...
            //  ÕœÌœ «·‰Ê⁄ decimal Â‰« ·√‰ «·‹ SUM »Ì—Ã⁄ —ﬁ„ ⁄‘—Ì œﬁÌﬁ „‰ «·‹ DB À„  ÕÊÌ·Â ·‹ double
